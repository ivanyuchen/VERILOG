...
// Command     : write_verilog -force -mode synth_stub -rename_top PCSNN_block_design_axi_smc_0 -prefix
//               PCSNN_block_design_axi_smc_0_ PCSNN_block_design_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "PCSNN_block_design_axi_smc_0,bd_cc28,{}" *) (* CORE_GENERATION_INFO = "PCSNN_block_design_axi_smc_0,bd_cc28,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_cc28,Vivado 2025.2" *) 
module PCSNN_block_design_axi_smc_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN PCSNN_block_design_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken" *) input aclk /* synthesis syn_isclock = 1 */;
