...
// Command     : write_verilog -force -mode synth_stub -rename_top PCSNN_block_design_rst_ps7_0_100M_0 -prefix
//               PCSNN_block_design_rst_ps7_0_100M_0_ PCSNN_block_design_rst_ps7_0_100M_0_stub.v
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN PCSNN_block_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
